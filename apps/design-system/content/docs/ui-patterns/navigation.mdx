...
A vertical list of general areas within a product, allowing for clearer product-level organisation. Activating a ProductMenu item should trigger a URL change.

[ProductMenu component guidelines](../components/product-menu)
